...
slideBtn.addEventListener("click", (e) => {
    sideNav.classList.toggle("active-sidenav");
    document.querySelector(".overlay").classList.toggle("active-sidenav");
});
...
function hideSideNav() {
    sideNav.classList.remove("active-sidenav");
    document.querySelector(".overlay").classList.remove("active-sidenav");
}
