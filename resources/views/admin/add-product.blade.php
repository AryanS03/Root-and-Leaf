...
@section('admin_title','Add New Product')
@section('container')
<!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="{{ route('submit-product') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('title') }}" name="title" class="form-control" id="title" placeholder="Enter Product Title">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('short_description') }}" name="short_description" class="form-control" id="short-desc" placeholder="Enter short description">
