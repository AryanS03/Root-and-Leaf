...
@section('container')
<main>
    <section class="has-full-width-section contact-section blog">
        <div class="text-box">
            <h2>Our Blogs</h2>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row">
                    ...
                    @if(count($blogs) == 0)
                    <div class="jumbotron">
                        <h2 class="display-4"><span class="text-danger">Oops,</span> No Blogs Available!</h2>
                    </div>
                    @endif
                </div>
                <div class="row pt-3">
                    <div class="col-lg-12 d-flex justify-content-center">{{ $blogs->links() }}</div>
                </div>
            </div>
            <div class="col-lg-4">
